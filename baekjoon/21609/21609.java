...
public class Main {
    ...
    static Block bfs(int startRow, int startCol, Set<Location> visited) {
        ...
        List<Location> rainbowLocations = new ArrayList<>();
        ...
        for (Location location : locations) {
            if (matrix[location.row][location.col] > 0) {
                ...
                rainbowLocations.add(location);
            }
        }

        for (Location rainbowLocation : rainbowLocations) {
            visited.remove(rainbowLocation);
        }
        ...
        return new Block(locations, nonRainbowLocations.get(0), rainbowLocations.size());
    }
